...
var priceFrom = document.querySelector("input#price-from");
var priceTo = document.querySelector("input#price-to");

if (priceFrom) {
  priceFrom.addEventListener("change", function (e) {
    priceSlider.noUiSlider.set([priceFrom.value, null]);
  });
}

if (priceTo) {
  priceTo.addEventListener("change", function (e) {
